...
| `validate-dashboard-sql-docker-release` | `*.lvdash.json` | yes, `:v2.0.0` |
...
```shell
uvx --from git+https://github.com/godatadriven/databricks-validator@v2.0.0 \
...
```shell
pip install git+https://github.com/godatadriven/databricks-validator@v2.0.0
